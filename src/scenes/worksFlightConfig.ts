...
export const WORKS_FLIGHT_CONFIG = {
  systemHoldEnd: 0.15,
  mascotSwapStart: 0.15,
  mascotSwapEnd: 0.162,
  prepareEnd: 0.28,
  takeoffMotionStart: 0.15,
  takeoffMotionEnd: 0.28,
  centralFlightEnd: 0.68,
  landingMotionStart: 0.68,
  landingMotionEnd: 0.9,
  mascotHandoffStart: 0.892,
  videoStart: 0.15,
  videoEnd: 0.9,
  ...
  effectsStart: 0.15,
  effectsPeak: 0.34,
  effectsFadeStart: 0.68,
  effectsEnd: 0.9,
  headingStart: 0.9,
  headingEnd: 0.97,
  worksGroupingStart: 0.72,
  worksGroupingEnd: 0.82,
  worksOneStart: 0.9,
  worksTwoTransitionStart: 0.945,
  worksOneExitEnd: 0.965,
  worksTwoTransitionEnd: 0.975,
  desktopLengthVh: 780,
  mobileLengthSvh: 600,
